...
def main():
    ...
    # 读取配置
    proxies, WEB_PORT, LLM_MODEL, CONCURRENT_COUNT, _AUTH = get_conf('proxies', 'WEB_PORT', 'LLM_MODEL', 'CONCURRENT_COUNT', 'AUTHENTICATION')
    if _AUTH:
        logger.warning('AUTHENTICATION setting is ignored; using unified login')
    AUTHENTICATION = None
